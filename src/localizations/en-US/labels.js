const labels = {
  ...
  renewingNameOrId: 'Renewing products name or ID',
  parentNameOrId: 'Parent products name or ID',
  sourceNameOrId: 'Source products name or ID',
  targetNameOrId: 'Target products name or ID',
